...
public class UserDAO {
    ...
    private static final String DB_URL = "jdbc:mysql://localhost:3366/student_management";
    private static final String DB_USER = "root";
    private static final String DB_PASSWORD = "Trung2511.";
    ...
    //Change Password
    public boolean updatePassword(int userId, String newHashPassword) {
        ...
        try (Connection conn = getConnection();
            ...
            String hashedPassword = BCrypt.hashpw(newHashPassword, BCrypt.gensalt());
